...
alert("안전 사이트열기 프로그램(v.1.8.5)을 실행합니다. (복사하여 입력창에 붙여넣기 해도 됩니다. 코드실행이 종료되면 자동으로 코드가 다시 복사됩니다)")
...
else {let m2 = confirm("안전한 사이트로 추정되지만, 단축링크라면 당신을 속일수도 있습니다. 창을 여는것에 동의하시나요?");if(m2){open(m1)}else{alert("어쩌면 잘 생각한걸지도 몰라요.")};console.log("악성 사이트 방지 프로그램을 다시 시작하려면 F5를 눌러주세요.");window.copy("import('https://raw.githack.com/john0817-he/john0817/master/No_bad_site.js')");}
